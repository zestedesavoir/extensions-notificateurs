...
public final class Notification implements Parcelable {
  ...
  public Notification(int id, String title, boolean isRead, String url, int sender, Date pubdate, String contentType, int subscription) {
    this(id, title, isRead, url, new Member(sender), pubdate, contentType, new Subscription(subscription));
  }
  ...
  public Notification(JsonObject json) {
    this(JsonUtils.getInt(json, "id"),
        JsonUtils.getString(json, "title"),
        JsonUtils.getBoolean(json, "is_read"),
        JsonUtils.getString(json, "url"),
        JsonUtils.getObject(json, "sender", Member.class),
        JsonUtils.getDate(json, "pubdate"),
        JsonUtils.getString(json, "content_type"),
        JsonUtils.getObject(json, "subscription", Subscription.class));
  }
