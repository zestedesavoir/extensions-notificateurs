...
public final class Subscription implements Parcelable {
  ...
  public Subscription(int id) {
    this(id, null, false, false, null, null);
  }
  ...
  public Subscription(int id, int user, boolean isActive, boolean byEmail, String contentType, Date pubdate) {
    this(id, new Member(user), isActive, byEmail, contentType, pubdate);
  }
  ...
  public void user(Member user) {
    this.user = user;
  }

  public Subscription(JsonObject json) {
    this(JsonUtils.getInt(json, "id"),
        JsonUtils.getObject(json, "user", Member.class),
        JsonUtils.getBoolean(json, "is_active"),
        JsonUtils.getBoolean(json, "by_email"),
        JsonUtils.getString(json, "contentType"),
  ...
  @Override public boolean equals(Object o) {
    ...
    if (byEmail != that.byEmail) return false;
