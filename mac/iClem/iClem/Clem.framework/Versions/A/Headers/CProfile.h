...
typedef void(^CCheckProfileWithPK)(CMembre *membre, NSError *error);
...
@property (copy, nonatomic) CCheckProfileWithPK blocProfilePK;


- (void)checkProfileWithPK:(int)pk bloc:(CCheckProfileWithPK)bloc;
